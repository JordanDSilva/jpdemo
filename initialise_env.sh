...
export JUMPROPE_cores_pro=4 #Number of cores to use for 1/f, sky subtr, wisp rem
export JUMPROPE_cores_stack=4 #Number of cores to use internally for propaneWarpStackInVar
